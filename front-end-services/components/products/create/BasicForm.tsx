...
import useCategoryStore, { ICategory } from "@/api/category/useCategoryStore";
...
const BasicForm: React.FC<ProductPropertyProps> = observer(
  ({ formData, setFormData }) => {
    const fileInputRef = useRef<HTMLInputElement | null>(null);

    const { getCategoryList, categories } = useCategoryStore;
