...
const ProductList = observer(
  ({
    ...
    const { productList, skip, limit } = productStore;
    ...
    }, [searchQuery, selectedCategories, priceRange, sortBy, skip, limit]);
                  ...
                  <Card className="overflow-hidden h-full transition-all hover:shadow-md">
                    <div className="aspect-square relative">
                      ...
                      {product.previousPrice && (
                        <div className="absolute top-2 right-2 dark:bg-secondary dark:text-white bg-primary text-primary-foreground text-xs font-bold px-2 py-1 rounded">
                          SALE
                        </div>
                      )}
                    </div>
